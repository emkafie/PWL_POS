...
<div class="card card-outline card-primary">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="{{ url('level/export_pdf') }}" class="btn btn-sm btn-warning"><i class="bi bi-file-pdf"></i> Export Level</a>
            <a href="{{ url('level/export_excel') }}" class="btn btn-sm mt-1 btn-primary"><i class="bi bi-file-earmark-excel"></i> Export Level</a>
